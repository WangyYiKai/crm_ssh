									...
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer/findAllCustomerInfo.action" target=main>－ 客户信息查询</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman/findAllLinkManInfo.action" target=main>－ 联系人信息查询</A>
													</TD>
												</TR>
												<%--<TR>
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<%--<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer/calculateIndustry" target=main>－客户行业统计</A>
													</TD>
												</TR>
												--%><TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer/calculateSource" target=main>－客户来源统计</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
