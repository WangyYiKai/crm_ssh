...
<BODY>
	<s:form action="findAllLinkManInfo" namespace="/linkman">
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<td>联系人性别：</td>
													<td>
														<s:select list="#{'male':'男','female':'女'}" name="lkmGender" headerKey="" headerValue="---请选择---" class="textbox" id="sChannel2" style="WIDTH: 80px" maxLength="50"></s:select>
													</td>
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														...
														<s:elseif test="lkmGender=='female'">女</s:elseif>
													</TD>
													<TD>${lkmPhone }</TD>
													<TD>${lkmMobile }</TD>
													<TD>${lkmEmail }</TD>
